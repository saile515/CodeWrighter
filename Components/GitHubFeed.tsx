		...
		<li className=" bg-slate-800 p-2 my-1 rounded-lg">
			<a href={props.data.url} target="_blank">
				...
				<p className=" m-0 text-slate-500">
					By{" "}
					<a href={`https://www.github.com/${props.data.author}`} target="_blank" className=" hover:text-slate-400 transition-all">
						{props.data.author}
					</a>{" "}
					in{" "}
					<a href={`https://www.github.com/${props.data.repo}`} target="_blank" className=" hover:text-slate-400 transition-all">
						{props.data.repo}
					</a>
				</p>
